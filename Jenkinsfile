            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        echo "    certificate-authority-data: ${env.K8S_CA_CERT}" >> ${kubeconfig}
                        ...
                        echo "    client-certificate-data: ${env.K8S_CLIENT_CERT}" >> ${kubeconfig}
                        echo "    client-key-data: ${env.K8S_CLIENT_KEY}" >> ${kubeconfig}
                    """
